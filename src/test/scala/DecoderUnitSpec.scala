...
class DecoderUnitSpec extends ChiselFlatSpec {
  val inst:Map[String, (Int,Int,Int,Int,Int,Int,Int,Int,Int,Int,Int,Int,Int)] = Map(
    ...
    "ANDI"-> (0x53, 0x2, 0, 0, 2, 2, 0, 1, 1, 0x008, 0x4, 2, 0x0),
    "XORI"-> (0x5B, 0x3, 0, 0, 2, 2, 0, 1, 1, 0x008, 0x4, 2, 0x0),
    "ORI" -> (0x63, 0x4, 0, 0, 2, 2, 0, 1, 1, 0x008, 0x4, 2, 0x0),
    "LSLI"-> (0x2B, 0x5, 0, 0, 2, 2, 0, 1, 1, 0x008, 0x4, 2, 0x0),
    "LSRI"-> (0x33, 0x6, 0, 0, 2, 2, 0, 1, 1, 0x008, 0x4, 2, 0x0),
    "ASRI"-> (0x3B, 0x7, 0, 0, 2, 2, 0, 1, 1, 0x008, 0x4, 2, 0x0),
    ...
    "LUI" -> (0x04, 0x8, 0, 0, 2, 2, 2, 1, 1, 0x040, 0x4, 2, 0x0),
    ...
    "JSAL"-> (0x1E,0x00, 0, 2, 2, 2, 1, 1, 1, 0x080, 0x2, 1, 0x4),
